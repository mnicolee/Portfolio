...
![](papers/kcr/base-chamber-01.png){.paper-figure style="max-width:780px" fig-alt="Base chamber design: CNC milling, magnet-held modular components, assembly, and the assembled chamber under infrared light in the dark"}
...
![](papers/kcr/cut-out-02.png){.paper-figure style="max-width:780px" fig-alt="Iterations of the worm arena: a failed 96-well prototype, tests of different grid sizes and layouts, the chosen size for C. elegans, and the final schematic"}
...
![](papers/kcr/stereoscope-cutout-03.png){.paper-figure style="max-width:720px" fig-alt="Custom C-mount camera adapter modeled in Onshape (left) and 3D-printed and fitted to the stereomicroscope (right)"}
...
![](papers/kcr/worm-chamber-stereo-04.png){.paper-figure style="max-width:720px" fig-alt="The fully assembled C. elegans tracking rig: camera, adapter, stereomicroscope, worm arena, and IR plus optogenetic illumination"}
...
![](papers/kcr/dlc-worm-05.png){.paper-figure fig-alt="DeepLabCut pose-estimation overlay showing ten key points labeled head-to-tail along a single worm"}

[**Figure 5 — Pose tracking.** DeepLabCut pose-estimation overlay: ten key points labeled
head-to-tail along a single worm (color gradient, head → tail).]{.fig-legend}
...
package ([Celegans_tracking](https://github.com/lnicole08/Celegans_tracking)) then converts the
...
<div class="video-row">
  <figure class="video-item">
    <video class="paper-video" autoplay muted loop playsinline preload="auto">
      <source src="papers/kcr/wt-without-dlc.mp4" type="video/mp4">
    </video>
    <figcaption>Raw stereoscope video</figcaption>
  </figure>
  <figure class="video-item">
    <video class="paper-video" autoplay muted loop playsinline preload="auto">
      <source src="papers/kcr/wt-with-dlc.mp4" type="video/mp4">
    </video>
    <figcaption>DeepLabCut pose tracking</figcaption>
  </figure>
</div>

[**Video — before and after tracking.** The same worm shown raw (left) and with the DeepLabCut
pose overlay (right), playing side by side. Both clips are muted and loop automatically.]{.fig-legend}

[]{.section-rule}

[See the science this rig was built for → the KCR silencing study](papers/kcr/index.qmd){.read-more}
