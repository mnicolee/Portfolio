...
<div class="hsec">
  <div class="three">
    <div class="col">
      <div class="k-row">
        <span class="kt"><span class="ic ic--brain"><svg viewBox="0 0 48 48" aria-hidden="true"><path d="M24 10 C20 7 14 8 13 13 C8 13 6 19 10 22 C7 25 9 31 14 30 C15 34 22 34 24 30 C26 34 33 34 34 30 C39 31 41 25 38 22 C42 19 40 13 35 13 C34 8 28 7 24 10 Z"/><path d="M24 10 L24 30"/><path d="M17 16 C20 18 20 22 17 24"/><path d="M31 16 C28 18 28 22 31 24"/></svg></span>The neuroscience</span>
      </div>
    ...
    <div class="col">
      <div class="k-row">
        <span class="kt"><span class="ic ic--wrench"><svg viewBox="0 0 48 48" aria-hidden="true"><path d="M45.4 38 l-18.2 -18.2 c1.8 -4.6 .8 -10 -3 -13.8 -4 -4 -10 -4.8 -14.8 -2.6 L18 12 12 18 3.2 9.4 C.8 14.2 1.8 20.2 5.8 24.2 c3.8 3.8 9.2 4.8 13.8 3 l18.2 18.2 c.8 .8 2 .8 2.8 0 l4.6 -4.6 c1 -.8 1 -2.2 .2 -2.8 z"/></svg></span>The nuts &amp; bolts</span>
      </div>
    ...
    <div class="col">
      <div class="k-row">
        <span class="kt"><span class="ic ic--plot"><svg viewBox="0 0 48 48" aria-hidden="true"><path d="M6 35 H42"/><path d="M9 35 C18 35 18 11 24 11 C30 11 30 35 39 35"/><path d="M24 15 V37"/><circle class="dot" cx="24" cy="25" r="3"/></svg></span>The numbers</span>
      </div>
      <div class="kd">
    ...
    <div class="slides">
      ...
      <div class="slide">
        ...
        <div class="txt">
          ...
          <h3><em>C. elegans</em> - a behavior tracking rig</h3>
